...
userRouter.get("/", authenticateToken, getUsersController);
...
userRouter.patch("/deactivate/:id", authenticateToken, authorizeRoles('admin'), deactivateUserController);
userRouter.delete("/delete/:id", authenticateToken, authorizeRoles('admin'), deleteUserController);
